...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionBar.addTab(actionBar.newTab().setText(R.string.tab_encryption).setTabListener(this));
		actionBar.addTab(actionBar.newTab().setText(R.string.tab_decryption).setTabListener(this));
